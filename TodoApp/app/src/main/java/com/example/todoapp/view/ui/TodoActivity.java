    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper (new ItemTouchHelper.SimpleCallback(0,
            ...
            public boolean onMove(@NonNull RecyclerView recyclerView,
                ...
                Toast.makeText(TodoActivity.this, "on Move", Toast.LENGTH_SHORT).show();
                return true;// true if moved, false otherwise
            }
            @Override
            public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                Toast.makeText(TodoActivity.this, "Todo list delete ", Toast.LENGTH_SHORT).show();
                //Remove swiped item from list and notify the RecyclerView
                todoViewModel.delete(todoListAdapter.getClickListener (viewHolder.getLayoutPosition()));
            }
